...
#define FULL_AREA_EXPLOSION  11123040.0f
...
BOOL obj_ServerGrenade::OnCreate()
{
	...
	//Not need to report it, we should keep server with max. performance
	...
	switch (m_ItemID)
	{
		...
		//BURSTFIRE
			FileName	= "Data\\ObjectsDepot\\INB_Weapons\\INB_EXP_SmokeG_INCEN.sco";
			bsize		= r3dPoint3D(0.03f, 0.03f, 0.03f);
			break;
		case WeaponConfig::ITEMID_ChemLight:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_Flare:
		case WeaponConfig::ITEMID_FlareGun:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\EXP_Flare.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_ChemLightBlue:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight_blue.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_ChemLightGreen:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight_green.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_ChemLightOrange:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight_orange.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_ChemLightRed:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight_red.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		case WeaponConfig::ITEMID_ChemLightYellow:
			FileName	= "Data\\ObjectsDepot\\INB_Loot\\inb_item_chemlight_yellow.sco";
			bsize		= r3dPoint3D(0.02f, 0.01f, 0.02f);
			break;
		default:
...
void obj_ServerGrenade::OnExplode()
{
	...
	// EXPLOSION AREA HERE USING Ammo_Area on itemdb.xml
