...
BOOL obj_ServerLockbox::OnCreate()
{
	...
	if(m_ItemID == WeaponConfig::ITEMID_Locker)
	{
		FileName = "Data\\ObjectsDepot\\INB_SurvivalStructures\\INB_container_build_01.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else if(m_ItemID == WeaponConfig::ITEMID_SS_Locker)
	{
		FileName = "Data\\ObjectsDepot\\SS_Gameplay\\ss_lootbox_01.sco";
		bsize    = r3dPoint3D(1.0900440f, 1.2519419f, 0.79267800f);
	}
	else
