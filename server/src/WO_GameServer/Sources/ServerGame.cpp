...
void PlayGameServer()
{
  ...
  switch(gServerLogic.ginfo_.mapId) 
  {
    ...
    case GBGameInfo::MAPID_Editor_Particles: 
      r3dGameLevel::SetHomeDir("Dropbox\\WorkInProgress\\Editor_Particles"); 
      break;
    case GBGameInfo::MAPID_AM_Island: 
      r3dGameLevel::SetHomeDir("alpha_island"); 
      break;
    case GBGameInfo::MAPID_AM_Battleroyale: 
      r3dGameLevel::SetHomeDir("am_battleroyale"); 
      break;
    case GBGameInfo::MAPID_AM_Compound: 
      r3dGameLevel::SetHomeDir("am_compound"); 
      break;
    case GBGameInfo::MAPID_AM_ConventionC: 
      r3dGameLevel::SetHomeDir("am_convention_center"); 
      break;
    case GBGameInfo::MAPID_AM_Devmap: 
      r3dGameLevel::SetHomeDir("am_devmap"); 
      break;
    case GBGameInfo::MAPID_AM_PineTop: 
      r3dGameLevel::SetHomeDir("am_pinetop"); 
      break;
    case GBGameInfo::MAPID_AM_RoTB: 
      r3dGameLevel::SetHomeDir("am_RotB_lms_01"); 
      break;
    case GBGameInfo::MAPID_AM_Nevada: 
      r3dGameLevel::SetHomeDir("am_nevada"); 
      break;
    case GBGameInfo::MAPID_AM_SouthWest: 
      r3dGameLevel::SetHomeDir("am_southwest"); 
      break;
