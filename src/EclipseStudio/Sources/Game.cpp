...
static void LoadGameWithLoadScreen(const char* LevelFolder )
{
	...
	int gameMode = -1;
	if(strstr(LevelFolder, "am_devmap"))
	{
		//levelName = gLangMngr.getString("MapDevmap");
		levelDesc = gLangMngr.getString("MapDevmap");
		gameMode = GBGameInfo::MAPID_AM_Devmap;
    }
	else if(strstr(LevelFolder, "am_pinetop"))
	{
		//levelName = gLangMngr.getString("MapPinetop");
		levelDesc = gLangMngr.getString("MapPinetop");
		gameMode = GBGameInfo::MAPID_AM_PineTop;
    }
	else if(strstr(LevelFolder, "am_compound"))
	{
		//levelName = gLangMngr.getString("MapCompound");
		levelDesc = gLangMngr.getString("MapCompound");
		gameMode = GBGameInfo::MAPID_AM_Compound;
    }
	else if(strstr(LevelFolder, "am_convention_center"))
	{
		//levelName = gLangMngr.getString("MapConvention");
		levelDesc = gLangMngr.getString("MapConvention");
		gameMode = GBGameInfo::MAPID_AM_ConventionC;
    }
	else if(strstr(LevelFolder, "am_nevada"))
	{
		//levelName = gLangMngr.getString("MapNevada");
		levelDesc = gLangMngr.getString("MapNevada");
		gameMode = GBGameInfo::MAPID_AM_Nevada;
    }
	else if(strstr(LevelFolder, "am_southwest"))
	{
		//levelName = gLangMngr.getString("MapSouthWest");
		levelDesc = gLangMngr.getString("MapSouthWest");
		gameMode = GBGameInfo::MAPID_AM_SouthWest;
    }
	else if(strstr(LevelFolder, "am_battleroyale"))
	{
		//levelName = gLangMngr.getString("MapSouthWest");
		levelDesc = gLangMngr.getString("MapSouthWestBR");
		gameMode = GBGameInfo::MAPID_AM_Battleroyale;
    }
