...
void CGameRewards::InitDefaultRewards()
{
	...
	SetReward(1, "ZombieKill", 3, 3, 6, 6);
	SetReward(2, "SuperZombieKill", 3, 3, 6, 6);
	SetReward(3, "PlayerKill", 2, 3, 2, 3);	
	//SetReward(1, "ZombieKill", 0, 10, 0, 20);
	//SetReward(2, "Super ZombieKill", 250, 50, 500, 100);
	//SetReward(3, "PlayerKill", 100, 0, 200, 0);
	SetReward(4, "Headshot", 1, 1, 1, 1);
	SetReward(5, "Killstreak2", 1, 1, 1, 1);
	SetReward(6, "Killstreak3", 1, 1, 1, 1);
	SetReward(7, "Killstreak4", 1, 1, 1, 1);
	SetReward(8, "Killstreak5", 1, 1, 1, 1);
	SetReward(9, "Killstreak6", 1, 1, 1, 1);
	SetReward(10, "Killstreak7", 1, 1, 1, 1);
	SetReward(11, "Killstreak8", 1, 1, 1, 1);
	SetReward(12, "Kill15NotDying", 1, 1, 1, 1);
	SetReward(13, "Kill25NotDying", 1, 1, 1, 1);
	SetReward(14, "Kill50NotDying", 1, 1, 1, 1);
	SetReward(15, "Kill100NotDying", 1, 1, 1, 1);
	SetReward(16, "ExplosionKill", 1, 1, 1, 1);
}
