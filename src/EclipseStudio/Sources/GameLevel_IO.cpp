...
GameObject * LoadLevelObject ( pugi::xml_node & curNode, bool JustForBuildings=false )
{
...
#ifdef FINAL_BUILD
	if(strcmp(r3dGameLevel::GetHomeDir(), "Levels\\FrontEnd_Render") && r_fastload->GetBool())
	{
		if(!strcmp( class_name, "obj_StoreNPC" ) || 
			!strcmp( class_name, "obj_Gravestone" ) || 
			!strcmp( class_name, "obj_RepairBench" ) ||
			!strcmp( class_name, "obj_Building" ) ||
			!strcmp( class_name, "obj_EnvmapProbe" ) ||
			!strcmp( class_name, "obj_ReverbZoneBox" ) ||
			!strcmp( class_name, "obj_Terrain" ) ||
			!strcmp( class_name, "obj_BattleArena" ) ||
			!strcmp( class_name, "obj_ChaosObject" ) ||
			!strcmp( class_name, "obj_Cold" ) ||
			!strcmp( class_name, "obj_CookingRack" ) ||
			!strcmp( class_name, "obj_CraftNPC" ) ||
			!strcmp( class_name, "obj_DamageArea" ) ||
			!strcmp( class_name, "obj_Dmg" ) ||
			!strcmp( class_name, "obj_Door" ) ||
			!strcmp( class_name, "obj_MarketNPC" ) ||
			!strcmp( class_name, "obj_RadBox" ) ||
			!strcmp( class_name, "obj_Stairs" ) ||
			!strcmp( class_name, "obj_Traps" ) ||
			!strcmp( class_name, "obj_UAV" ) ||
			!strcmp( class_name, "obj_WaterWell" ) ||
			!strcmp( class_name, "obj_MissionStateObject" ) ||
	...
	if(strcmp(r3dGameLevel::GetHomeDir(), "Levels\\FrontEnd_Render") && r_fastload->GetBool() && !g_bEditMode)
	{
		if(!strcmp( class_name, "obj_StoreNPC" ) || 
			!strcmp( class_name, "obj_Gravestone" ) || 
			!strcmp( class_name, "obj_RepairBench" ) ||
