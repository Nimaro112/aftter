...
void LanguageManager::Init(Languages lang)
{
	...
	if(lang == LANG_EN)
		readLanguageFile("data/LangPack/am_english.lang");
	else if(lang == LANG_RU)
		readLanguageFile("data/LangPack/am_russian.lang");
	else if(lang == LANG_FR)
		readLanguageFile("data/LangPack/am_french.lang");
	else if(lang == LANG_DE)
		readLanguageFile("data/LangPack/am_german.lang");
	else if(lang == LANG_IT)
		readLanguageFile("data/LangPack/am_italian.lang");
	else if(lang == LANG_SP)
		readLanguageFile("data/LangPack/am_spanish.lang");
	else
