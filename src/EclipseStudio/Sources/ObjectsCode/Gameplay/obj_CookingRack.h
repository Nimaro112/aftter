...
class obj_CookingRack : public MeshGameObject
{
	DECLARE_CLASS(obj_CookingRack, MeshGameObject)
	
public:
	float		useRadius;
		
	static std::vector<obj_CookingRack*> LoadedCookboxes;
public:
	obj_CookingRack();
	virtual ~obj_CookingRack();
