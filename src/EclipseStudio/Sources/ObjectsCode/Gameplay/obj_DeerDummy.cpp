...
obj_DeerDummy::obj_DeerDummy()
{
	...
	if(g_deerBindSkeleton == NULL) 
	{
		...
		g_deerBindSkeleton->LoadBinary("Data\\ObjectsDepot\\G3_Animals\\Char_Deer_01.skl");
...
void obj_DeerDummy::ReloadMesh()
{
	...
	default:
	case DEERVNT_Buck:
		mesh = r3dGOBAddMesh("Data\\ObjectsDepot\\G3_Animals\\Char_Deer_01.sco");
		break;
	case DEERVNT_Doe:
		mesh = r3dGOBAddMesh("Data\\ObjectsDepot\\G3_Animals\\Char_Deer_02_Doe.sco");
		break;
	}
}
