...
BOOL obj_Gravestone::Load(const char *fname)
{
	...
	{
	default:
		case 0:	cpMeshName = "Data\\ObjectsDepot\\SS_Gameplay\\tombstone.sco";	break;
		case 1:	cpMeshName = "Data\\ObjectsDepot\\SS_Gameplay\\tombstone.sco";	break;
		case 2:	cpMeshName = "Data\\ObjectsDepot\\SS_Gameplay\\tombstone.sco";	break;
	};
...
{
	m_ActionUI_Title = gLangMngr.getString("Tombstone");
