...
#include "obj_MarketNPC.h"

IMPLEMENT_CLASS(obj_BaseNPC, "obj_BaseNPC", "Object");
AUTOREGISTER_CLASS(obj_BaseNPC);

IMPLEMENT_CLASS(obj_MarketNPC, "obj_MarketNPC", "Object");
AUTOREGISTER_CLASS(obj_MarketNPC);
...
BOOL obj_BaseNPC::Load(const char *fname)
{
	...
	sprintf(cpMeshName, "Data\\ObjectsDepot\\CharactersNew\\CharacterNpc\\%s.sco", m_NPCMeshName);
...
obj_MarketNPC::obj_MarketNPC() : obj_BaseNPC()
{
