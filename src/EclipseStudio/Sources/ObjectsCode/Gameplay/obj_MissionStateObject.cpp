...
BOOL obj_MissionStateObject::Load(const char *name)
{
	...
	FileName = "Data\\ObjectsDepot\\TS_Furniture_v2\\ts_furn_props_book_05.sco";
...
void obj_MissionStateObject::InitObjLists()
{
	...
	MissionStateObjCatNames.push_back("G3_Gameplay");
	MissionStateObjCatNames.push_back("INB_InteriorProps1");
	MissionStateObjCatNames.push_back("TS_Props_Int_v2");
}
