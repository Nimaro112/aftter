...
class obj_WaterWell : public MeshGameObject
{
	DECLARE_CLASS(obj_WaterWell, MeshGameObject)
	
public:
	float		useRadius;
		
	static std::vector<obj_WaterWell*> LoadedWaterboxes;
public:
	obj_WaterWell();
	virtual ~obj_WaterWell();
