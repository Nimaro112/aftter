...
BulletShellMngr::BulletShellMngr()
{
	...
	m_shellMeshes[0] = r3dGOBAddMesh("Data/ObjectsDepot/ROTB_AmmoShells/shell_9mm.sco", true, false, false, true); r3d_assert(m_shellMeshes[0]);
	m_shellMeshes[1] = r3dGOBAddMesh("Data/ObjectsDepot/ROTB_AmmoShells/shell_rifle.sco", true, false, false, true); r3d_assert(m_shellMeshes[1]);
	m_shellMeshes[2] = r3dGOBAddMesh("Data/ObjectsDepot/ROTB_AmmoShells/shell_12gauge.sco", true, false, false, true); r3d_assert(m_shellMeshes[2]);
