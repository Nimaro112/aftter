...
public:
	...
	const SkinRecipeConfig* getSkinRecipeConfig(uint32_t itemID);
...
protected:
	...
	virtual SkinRecipeConfig* loadSkinRecipeItem(pugi::xml_node& xmlItem);////// SKIN
	...
	uint32_t	m_NumSkinsRecipesLoaded;
