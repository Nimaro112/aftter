...
private:
	...
	void eventShowInventory(r3dScaleformMovie* pMovie, const Scaleform::GFx::Value* args, unsigned argCount);
	...
	void UpdateSkinIcons(const wiCharDataFull& slot, bool OriginalSkin);
	...
	uint32_t	m_ChangeOutfit_newHair; // hair system
...
// char create
	...
	int		mStore_BuyQuantity; // Quantity Option
	...
	int		m_CreateBodyIdx;
	int		m_CreateHairIdx; // hair system
	int		m_CreateHeadIdx;
	int		m_CreateLegsIdx;
