...
void StartLoadingScreen()
{
	...
	gLoadingScreen = game_new LoadingScreen( "Data\\Interface\\Game_HUD_Loading.swf" );
...
int DoConnectScreen( volatile LONG* Loading, const char* Message, float TimeOut )
{
	...
	gLoadingScreen->SetData( "Data\\Interface\\ConnectScreen.dds", gLangMngr.getString("Connecting"), Message, NULL );
