...
public:
  public:
	...
	BYTE		isBattleRoyaleMode; //battleroyale
	...
	int		ProcessWorldEvent(GameObject* fromObj, DWORD eventId, DWORD peerId, const void* packetData, int packetSize);
	 ...
	 DEFINE_PACKET_FUNC(PKT_C2S_QuickRevive);
	 DEFINE_PACKET_FUNC(PKT_S2C_RespawnPlayer);
	 DEFINE_PACKET_FUNC(PKT_C2S_BattleRoyale);
#ifdef MISSIONS
	 ...
	 DEFINE_PACKET_FUNC(PKT_S2C_AirBombMapUpdate);
	 ...
	 DEFINE_PACKET_FUNC(PKT_S2C_BombItemYPosition);
	 DEFINE_PACKET_FUNC(PKT_S2C_SendDataDoor);
	 DEFINE_PACKET_FUNC(PKT_S2C_ChaosTrack);
	 DEFINE_PACKET_FUNC(PKT_S2C_LockboxOpReq);
	 DEFINE_PACKET_FUNC(PKT_S2C_LockboxContent);
	 DEFINE_PACKET_FUNC(PKT_S2C_DroppedOpReq);
	 DEFINE_PACKET_FUNC(PKT_S2C_DroppedContent);
	 DEFINE_PACKET_FUNC(PKT_S2C_ARDBOXOpReq);
	 DEFINE_PACKET_FUNC(PKT_S2C_ARDBOXContent);
	 ...
	 DEFINE_PACKET_FUNC(PKT_S2C_UpdateWpnSkinSelected);
	 DEFINE_PACKET_FUNC(PKT_S2C_AirDropOnMap);
	 DEFINE_PACKET_FUNC(PKT_S2C_AirBombOnMap);
