...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// needs to be upped EACH time Game.exe changes to make sure that PunkBuster will work properly
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
static const int NUM_WEAPONS_ON_PLAYER = wiCharDataFull::CHAR_LOADOUT_ITEM6 + 1 + 1; // one more for unarmed weapon
...
enum pkttype_e
{
  ...
  PKT_C2S_BackpackDropAll, // DROP ALL ITEM
  ...
  // server dropped backpack
  PKT_S2C_DroppedOpReq, // request new code or ask for code, or confirm moving item from\to dropped
  PKT_C2S_DroppedOpAns, // sent new code or send current code for dropped
  PKT_C2S_DroppedKeyReset, // when owner wants to reset key code
  PKT_S2C_DroppedContent, // server sends a bunch of those for each item in dropped, once code was accepted
  PKT_C2S_DroppedItemBackpackToDropped, // request to move item from backpack to dropped
  PKT_C2S_DroppedItemDroppedToBackpack, // request to mvoe item from dropped to backpack
  PKT_C2S_DroppedPickup,
  
  // server AIRDROP BOX
  PKT_S2C_ARDBOXOpReq, // request new code or ask for code, or confirm moving item from\to dropped
  PKT_C2S_ARDBOXOpAns, // sent new code or send current code for dropped
  PKT_C2S_ARDBOXKeyReset, // when owner wants to reset key code
  PKT_S2C_ARDBOXContent, // server sends a bunch of those for each item in dropped, once code was accepted
  PKT_C2S_ARDBOXItemBackpackToARDBOX, // request to move item from backpack to dropped
  PKT_C2S_ARDBOXItemARDBOXToBackpack, // request to mvoe item from dropped to backpack
  PKT_C2S_ARDBOXPickup,
  ...
  PKT_S2C_AirBombMapUpdate,
  PKT_S2C_AirBombOnMap,
  ...
  PKT_C2C_StartDance,
  PKT_C2C_StartBackflip,
  
  PKT_C2C_StartSitdown,
  PKT_C2C_StartSwinslow,
  PKT_C2C_StartPlayerdead,
  PKT_C2C_StartCrounched,
...
/////////////////////// Character Voice Command ////////////////////
  PKT_C2C_CharVoiceOne,
  PKT_C2C_CharVoiceTwo,
  PKT_C2C_CharVoiceThree,
  PKT_C2C_CharVoiceFour,
  PKT_C2C_CharVoiceFive,
  PKT_C2C_CharVoiceSix,
  PKT_C2C_CharVoiceSeven,
  PKT_C2C_CharVoiceEight,
  PKT_C2C_CharVoiceNine,
/////////////////////// Character Voice Command ////////////////////
  ...
  // update weapon skins selected
  PKT_S2C_UpdateWpnSkinSelected,
  PKT_C2S_LearnSkinItem,
...
struct PKT_S2C_inBattle_s : public DefaultPacketMixin<PKT_S2C_inBattle>
{
	bool inBattle;
};
...
struct PKT_C2S_QuickRevive_s : public DefaultPacketMixin<PKT_C2S_QuickRevive>
{
	gp2pnetid_t	PlayerID;
	int SpawnSelect;
};

struct PKT_C2S_BattleRoyale_s : public DefaultPacketMixin<PKT_C2S_BattleRoyale>
{
	//gp2pnetid_t	PlayerID;
	int MessageID;
	char gamertag[32*2];
...
struct PKT_S2C_CreatePlayer_s : public DefaultPacketMixin<PKT_S2C_CreatePlayer>
{
	...
	DWORD		ArmorID;
	DWORD		HeadGearID;
	DWORD		ScarfGearID; // scarf id
	DWORD		MaskGearID; // mask id
	DWORD		Item0;
	DWORD		Item1;
	DWORD		Item2;
	DWORD		Item3;
	...
	BYTE seatPosition;
#endif
	WeaponSkins WpnSKIN[MAX_WEAPONS_SKINEABLED];
};
...
struct PKT_C2S_PlayerDropArrow_s : public DefaultPacketMixin<PKT_C2S_PlayerDropArrow>
{
    // Drop Arrow
    r3dPoint3D    fire_to;
};
...
struct PKT_C2S_OpenCase_s : public DefaultPacketMixin<PKT_C2S_OpenCase>
{
	BYTE		WeaponSlot;
...
/////////////////////////// Taunt Anim System ///////////////////////////
struct PKT_C2C_StartHorse_s : public DefaultPacketMixin<PKT_C2C_StartHorse>
{
	//Empty
};
...
struct PKT_C2C_StartDance_s : public DefaultPacketMixin<PKT_C2C_StartDance>
{
	//Empty
};

struct PKT_C2C_StartBackflip_s : public DefaultPacketMixin<PKT_C2C_StartBackflip>
{
	//Empty
};

///////
struct PKT_C2C_StartSitdown_s : public DefaultPacketMixin<PKT_C2C_StartSitdown>
{
	//Empty
};
struct PKT_C2C_StartSwinslow_s : public DefaultPacketMixin<PKT_C2C_StartSwinslow>
{
	//Empty
};
struct PKT_C2C_StartPlayerdead_s : public DefaultPacketMixin<PKT_C2C_StartPlayerdead>
{
	//Empty
};
struct PKT_C2C_StartCrounched_s : public DefaultPacketMixin<PKT_C2C_StartCrounched>
{
	//Empty
};
...
struct PKT_C2C_StartDrink_s : public DefaultPacketMixin<PKT_C2C_StartDrink>
{
	//Empty
};

struct PKT_C2C_StartTalk_s : public DefaultPacketMixin<PKT_C2C_StartTalk>
{
	//Empty
};

/////////////////////// Character Voice Command ////////////////////
struct PKT_C2C_CharVoiceOne_s : public DefaultPacketMixin<PKT_C2C_CharVoiceOne>
{
	//Empty
};
struct PKT_C2C_CharVoiceTwo_s : public DefaultPacketMixin<PKT_C2C_CharVoiceTwo>
{
	//Empty
};
struct PKT_C2C_CharVoiceThree_s : public DefaultPacketMixin<PKT_C2C_CharVoiceThree>
{
	//Empty
};
struct PKT_C2C_CharVoiceFour_s : public DefaultPacketMixin<PKT_C2C_CharVoiceFour>
{
	//Empty
};
struct PKT_C2C_CharVoiceFive_s : public DefaultPacketMixin<PKT_C2C_CharVoiceFive>
{
	//Empty
};
struct PKT_C2C_CharVoiceSix_s : public DefaultPacketMixin<PKT_C2C_CharVoiceSix>
{
	//Empty
};
struct PKT_C2C_CharVoiceSeven_s : public DefaultPacketMixin<PKT_C2C_CharVoiceSeven>
{
	//Empty
};
struct PKT_C2C_CharVoiceEight_s : public DefaultPacketMixin<PKT_C2C_CharVoiceEight>
{
	//Empty
};
struct PKT_C2C_CharVoiceNine_s : public DefaultPacketMixin<PKT_C2C_CharVoiceNine>
{
	//Empty
};
/////////////////////// Character Voice Command ////////////////////

struct PKT_C2C_StartRepair_s : public DefaultPacketMixin<PKT_C2C_StartRepair>
{
	//Empty
};

struct PKT_C2C_StartEat_s : public DefaultPacketMixin<PKT_C2C_StartEat>
{
	//Empty
};
...
struct PKT_S2C_BombItemYPosition_s : public DefaultPacketMixin<PKT_S2C_DropItemYPosition>
{
	float YPos;
	gp2pnetid_t	spawnID;
};
...
struct PKT_S2C_ChaosTrack_s : public DefaultPacketMixin<PKT_S2C_ChaosTrack>
{
	gp2pnetid_t	ChaosID;
	BYTE		m_ChaosEnable;
...
struct PKT_S2C_DroppedOpReq_s : public DefaultPacketMixin<PKT_S2C_DroppedOpReq>
{
	enum DroppedOpReq
	{
		LBOR_Error = 0,
		...
		LBOR_WrongCode,
		LBOR_StartingToSendContent,
		LBOR_DoneSendingContent, // after openning Dropped, server will send content and will finish with this packet
		LBOR_CodeChanged,
		LBOR_SecurityLockdown,
		LBOR_NotOwner,
		LBOR_Close,
	...
	BYTE		op; 
	gp2pnetid_t	droppedID;
};

struct PKT_C2S_DroppedOpAns_s : public DefaultPacketMixin<PKT_C2S_DroppedOpAns>
{
	gp2pnetid_t	droppedID;
	char		AccessCodeS[32];
};

struct PKT_C2S_DroppedKeyReset_s : public DefaultPacketMixin<PKT_C2S_DroppedKeyReset>
{
	gp2pnetid_t	droppedID;
	char		old_AccessCodeS[32];
	char		new_AccessCodeS[32];
...
struct PKT_S2C_DroppedContent_s : public DefaultPacketMixin<PKT_S2C_DroppedContent>
{
	wiInventoryItem item;
};

struct PKT_C2S_DroppedItemDroppedToBackpack_s : public DefaultPacketMixin<PKT_C2S_DroppedItemDroppedToBackpack>
{
	gp2pnetid_t	droppedID;
	char		AccessCodeS[32]; // todo: maybe replace with some temp pin?
	uint32_t	DroppedInventoryID;	// don't confuse with InventoryID of item, this is index inside dropped
	BYTE		SlotTo;			// or 0xFF if server should decide target slot
	int		    Amount;
...
struct PKT_C2S_DroppedItemBackpackToDropped_s : public DefaultPacketMixin<PKT_C2S_DroppedItemBackpackToDropped>
{
	gp2pnetid_t	droppedID;
	char		AccessCodeS[32];
	BYTE		SlotFrom;
...
struct PKT_C2S_DroppedPickup_s : public DefaultPacketMixin<PKT_C2S_DroppedPickup>
{
	gp2pnetid_t	droppedID;
	char		AccessCodeS[32];
};
struct PKT_S2C_ARDBOXOpReq_s : public DefaultPacketMixin<PKT_S2C_ARDBOXOpReq>
{
	enum ARDBOXOpReq
	{
		LBOR_Error = 0,
		...
		LBOR_WrongCode,
		LBOR_StartingToSendContent,
		LBOR_DoneSendingContent, // after openning ARDBOX, server will send content and will finish with this packet
		LBOR_CodeChanged,
		LBOR_SecurityLockdown,
		LBOR_NotOwner,
		LBOR_Close,
	...
	BYTE		op; 
	gp2pnetid_t	ARDBOXID;
};

struct PKT_C2S_ARDBOXOpAns_s : public DefaultPacketMixin<PKT_C2S_ARDBOXOpAns>
{
	gp2pnetid_t	ARDBOXID;
	char		AccessCodeS[32];
};

struct PKT_C2S_ARDBOXKeyReset_s : public DefaultPacketMixin<PKT_C2S_ARDBOXKeyReset>
{
	gp2pnetid_t	ARDBOXID;
	char		old_AccessCodeS[32];
	char		new_AccessCodeS[32];
...
struct PKT_S2C_ARDBOXContent_s : public DefaultPacketMixin<PKT_S2C_ARDBOXContent>
{
	wiInventoryItem item;
};

struct PKT_C2S_ARDBOXItemARDBOXToBackpack_s : public DefaultPacketMixin<PKT_C2S_ARDBOXItemARDBOXToBackpack>
{
	gp2pnetid_t	ARDBOXID;
	char		AccessCodeS[32]; // todo: maybe replace with some temp pin?
	uint32_t	ARDBOXInventoryID;	// don't confuse with InventoryID of item, this is index inside ARDBOX
	BYTE		SlotTo;			// or 0xFF if server should decide target slot
	int		    Amount;
...
struct PKT_C2S_ARDBOXItemBackpackToARDBOX_s : public DefaultPacketMixin<PKT_C2S_ARDBOXItemBackpackToARDBOX>
{
	gp2pnetid_t	ARDBOXID;
	char		AccessCodeS[32];
	BYTE		SlotFrom;
...
struct PKT_C2S_ARDBOXPickup_s : public DefaultPacketMixin<PKT_C2S_ARDBOXPickup>
{
	gp2pnetid_t	ARDBOXID;
	char		AccessCodeS[32];
};
...
struct PKT_S2C_AirBombMapUpdate_s : public DefaultPacketMixin<PKT_S2C_AirBombMapUpdate>
{
	r3dPoint3D	location;
	float		m_time;
};

struct PKT_S2C_AirBombOnMap_s : public DefaultPacketMixin<PKT_S2C_AirBombOnMap>
{
	uint32_t NumbeAirBomb;
};
...
struct PKT_S2C_CreateZombie_s : public DefaultPacketMixin<PKT_S2C_CreateZombie>
{
	...
	r3dPoint3D	moveCell;	// cell position from PKT_C2C_MoveSetCell
	DWORD		HeroItemID;	// ItemID of base character
	BYTE		HairIdx; // hair system - not for zombies
	BYTE		HeadIdx;
	BYTE		BodyIdx;
	BYTE		LegsIdx;
...
struct PKT_S2C_AddResource_s : public DefaultPacketMixin<PKT_S2C_AddResource>
{
	...
	int		ResStone;
	int		ResMetal;
	int     GameDollar;  // by bombillo test
};
...
struct PKT_S2C_UpdateWpnSkinSelected_s : public DefaultPacketMixin<PKT_S2C_UpdateWpnSkinSelected>
{
	gp2pnetid_t	targetId;
	DWORD		itemID;
	DWORD		Selected;
...
struct PKT_C2S_LearnSkinItem_s : public DefaultPacketMixin<PKT_C2S_LearnSkinItem>
{
	DWORD		ItemID;
	DWORD		SkinID;
	DWORD		OriginalID;
...
{
	static const int REPORT_PERIOD = 30; // we should send report every <this> sec
