...
#undef MK_CASE
  ...
  return NULL;
	...
	const r3dColor	r3dColor::gold(188,151,21);
	const r3dColor	r3dColor::lightblue(11,127,170);
	
	const r3dColor	r3dColor::lightyellow(254,169,60);
	const r3dColor	r3dColor::lightred(244,14,14);
	const r3dColor	r3dColor::lightgreen(78,167,57);
