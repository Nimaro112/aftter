...
void r3dThreadEntryHelper(threadEntry_fn fn, DWORD in)
{
	...
	if(!IsDebuggerPresent())
	{
		...
		info.pszUrl = L"https://25.91.238.22/GameAPI/app/php/api_CrashReport.php";
		...
		info.pszPrivacyPolicyURL = L"https://25.91.238.22/GameAPI/PrivacyPolicy_WarZ.htm";
		...
		char filePath[1024];
		res = crAddFile2(_T("R3Engine_logs.txt"), NULL, _T("Log file"), CR_AF_MAKE_FILE_COPY|CR_AF_MISSING_FILE_OK);
