...
r3dInputMappingMngr::r3dInputMappingMngr()
{
	...
	m_Mapping[KS_CHANGE_RATE_FIRE] =		KeyboardMapping(INPUTMAP_KEYBOARD, kbsV, "$HUD_Cntrl_ChangeFireRate", false);
	...
	m_Mapping[KS_ITEM5] =					KeyboardMapping(INPUTMAP_KEYBOARD, kbs7, "$HUD_Cntrl_Item5", false);
	m_Mapping[KS_ITEM6] =					KeyboardMapping(INPUTMAP_KEYBOARD, kbs8, "$HUD_Cntrl_Item6", false);
	...
	m_Mapping[KS_VOICE_PTT] =				KeyboardMapping(INPUTMAP_KEYBOARD, kbsLeftAlt, "$HUD_Cntrl_VoicePTT", false);
	...
	m_Mapping[KS_SHOW_ATTACHMENTS] =		KeyboardMapping(INPUTMAP_KEYBOARD, kbsX, "$HUD_Cntrl_ShowAttachments", false);
...
//#ifdef ENABLE_INGAME_STORE
	m_Mapping[KS_SHOW_STORE] =				KeyboardMapping(INPUTMAP_KEYBOARD, kbsF11, "$HUD_Cntrl_ShowStore", false);
//#endif
	...
	m_Mapping[KS_SHOW_VOICECMD] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsB, "$HUD_ActiveVoiceCmd", false);

	m_Mapping[KS_TURN_OFF_HUD] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsF12, "$HUD_Cntrl_TurnOffHUD", false);
	
#ifdef VEHICLES_ENABLED
	m_Mapping[KS_VEHICLE_UNSTUCK] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsF6, "$HUD_Cntrl_VehicleUnstuck", false);
