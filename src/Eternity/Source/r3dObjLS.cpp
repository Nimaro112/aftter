...
//static const uint32_t R3DMESH_BINARY_VERSION = 0xFADC0038; // change bin verkey
static const uint32_t R3DMESH_BINARY_VERSION = 0xDCFF0512; // change bin verkey
