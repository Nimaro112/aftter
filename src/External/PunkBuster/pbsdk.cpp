	...
	else if ( !_strnicmp( var_name, "mapname", 7 ) )
	{
		...
		if ( currentLocalPlayer )
		{
			...
			case GBGameInfo::MAPID_Editor_Particles: 
				...
				break;
			case GBGameInfo::MAPID_AM_Island:
				sprintf ( result, "AM_Island (%f, %f, %f)", pos.x, pos.y, pos.z ); 
				break;
			case GBGameInfo::MAPID_AM_Battleroyale: 
				sprintf ( result, "AM_Battleroyale (%f, %f, %f)", pos.x, pos.y, pos.z ); 
				break;
			case GBGameInfo::MAPID_AM_Compound: 
				sprintf ( result, "AM_Compound (%f, %f, %f)", pos.x, pos.y, pos.z ); 
				break;
			case GBGameInfo::MAPID_AM_ConventionC: 
				sprintf ( result, "AM_ConventionC (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_Devmap:
				sprintf ( result, "AM_Devmap (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_PineTop:
				sprintf ( result, "AM_PineTop (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_RoTB:
				sprintf ( result, "AM_RoTB (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_Nevada:
				sprintf ( result, "AM_Nevada (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_SouthWest:
				sprintf ( result, "AM_SouthWest (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_RentServer01:
				sprintf ( result, "AM_RentServer01 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			case GBGameInfo::MAPID_AM_RentServer02:
				sprintf ( result, "AM_RentServer02 (%f, %f, %f)", pos.x, pos.y, pos.z );  
				break;
			default:
