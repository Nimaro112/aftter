...
public:
	...
	/// Therefore,
	/// AddUploadsFromSubdirectory("Maps/Level1/"); would allow you to download using DownloadFromSubdirectory("Maps/Level1/Textures/"...
	/// but it would NOT allow you to download from DownloadFromSubdirectory("Maps/"... or DownloadFromSubdirectory("Maps/Level2/"...
	/// \pre You must call SetFileListTransferPlugin with a valid FileListTransfer plugin
