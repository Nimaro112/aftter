package warz.frontend {
	...
	public class MarketplaceScreen extends MovieClip 
	{
		...
		{
			Marketplace.DescrBlock.WeaponStats.visible = false;
			...
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.MOUSE_OVER, SlotRollOverFn);
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.MOUSE_OUT, SlotRollOutFn);
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.CLICK, SlotPressFn);
			
			
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.MOUSE_OVER, BtnRollOverFn);
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.MOUSE_OUT, BtnRollOutFn);
			Marketplace.BtnBack.Btn.addEventListener(MouseEvent.CLICK, BtnPressFn);
			Marketplace.BtnBack.ActionFunction = function()
			{			
			...
			Marketplace.Money.WebGCBtn.Btn.addEventListener(MouseEvent.MOUSE_OVER, BtnRollOverFn);
			Marketplace.Money.WebGCBtn.Btn.addEventListener(MouseEvent.MOUSE_OUT, BtnRollOutFn);
			Marketplace.Money.WebGCBtn.Btn.addEventListener(MouseEvent.CLICK, WebGCPressFn);
			Marketplace.Money.WebGCBtn.Text.Text.text = "$FR_UpgradeTrialAccount";
			Marketplace.Money.WebGCBtn.ActionFunction = function()
			{			
				FrontEndEvents.eventStorePurchaseGPRequest();
			}
			Marketplace.Money.BuyPrem.Btn.addEventListener(MouseEvent.MOUSE_OVER, BtnRollOverFn);
			Marketplace.Money.BuyPrem.Btn.addEventListener(MouseEvent.MOUSE_OUT, BtnRollOutFn);
			Marketplace.Money.BuyPrem.Btn.addEventListener(MouseEvent.CLICK, BuyPremPressFn);
			Marketplace.Money.BuyPrem.Text.Text.text = "$FR_BuyPremiumAccount";
			Marketplace.Money.BuyPrem.ActionFunction = function()
			{			
		...
		public function WebGCPressFn(evt:Event)
		{
			if(evt.currentTarget.parent.currentLabel != "inactive")
			{
		...
		public function BuyPremPressFn(evt:Event)
		{
			if(evt.currentTarget.parent.currentLabel != "inactive")
			{
				SoundEvents.eventSoundPlay("menu_click4");
		...
		public	function SlotPressFn4(evt:Event)
		{
			if(evt.currentTarget.parent.State != "active")
			{
				if (evt.currentTarget.parent.name != "BuyBtn")
		...
		public	function SlotPressFn6(evt:Event)
		{
			if(evt.currentTarget.parent.State != "active")
			{
				if (evt.currentTarget.parent.name != "BuyBtn")
				...
				SoundEvents.eventSoundPlay("menu_click6");
...
//					storeSlot.RentNum.Rent.text = "$FR_MARKETPLACE_PERMANENT";
			...
			if (button == "BuyBtn")
			{
				...
				if (SelectedItem)
				{
					...
					else 
					{
						...
						api.Main.MsgBox.showInfoInputMsg("$FR_BuyQty", "", eventBuyQtyCallback);
					}
				}
			}
		...
		public	function showDescription (slot)
		{
			var inventItem = null;
			Marketplace.DescrBlock.WeaponStats.visible = false;
			Marketplace.DescrBlock.Pic.y = 40.0;			
			...
			Marketplace.BuyBtn.Btn.removeEventListener(MouseEvent.CLICK, SlotPressFn6);
			...
			if (slot == null || slot.Item == null)
			{
				...
				Marketplace.DescrBlock.PlaneName.visible = false;
			...
			else
			{
				...
				// AlexRedd:: Stats
				if (item.catID == 20 || item.catID == 21 || item.catID == 22 || item.catID == 23 || item.catID == 25 || 
					item.catID == 26 || item.catID == 27 || item.catID == 29 || item.catID == 11 || item.catID == 13 ||
					item.catID == 19 || item.catID == 419 || item.catID == 12 || item.catID == 30 || item.catID == 33 || 
					SelectedItem.Item.itemID == 101256 || SelectedItem.Item.itemID == 101261 || SelectedItem.Item.itemID == 101262 || 
					SelectedItem.Item.itemID == 101300 || SelectedItem.Item.itemID == 101302 || SelectedItem.Item.itemID == 101303 || 
					SelectedItem.Item.itemID == 101304)               
				{
					Marketplace.DescrBlock.WeaponStats.visible = true;
					ParseStats(SelectedItem.Item);
				}
				...
				Marketplace.DescrBlock.PlaneName.visible = true;
				...
				Marketplace.BuyBtn.Btn.addEventListener(MouseEvent.CLICK, SlotPressFn6);
				Marketplace.BuyBtn.visible = true;
			}
		}

		// AlexRedd:: Stats
		public function ParseStats(item)
		{
			var statsArr = item["stats"];
			var	iterator:Number = 0;
			Marketplace.DescrBlock.WeaponStats.Stat1.visible = true;
			Marketplace.DescrBlock.WeaponStats.Stat2.visible = true;
			Marketplace.DescrBlock.WeaponStats.Stat3.visible = true;
			Marketplace.DescrBlock.WeaponStats.Stat5.visible = false;
			
			if (item.catID == 27 || item.catID == 29)// melee, grenade          
			{
				Marketplace.DescrBlock.WeaponStats.Stat1.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat2.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat3.visible = false;
				Marketplace.DescrBlock.Pic.y = 30.0;
					
				Marketplace.DescrBlock.WeaponStats.Stat4.Scale.scaleX = statsArr[0].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat4.Variable.text = statsArr[0].statName;
				Marketplace.DescrBlock.WeaponStats.Stat4.Value.text = String(statsArr[0].statValue)+"";					
			}
			else if (item.catID == 11 || item.catID == 13)// gears, helmets
			{
				Marketplace.DescrBlock.WeaponStats.Stat1.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat2.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat3.visible = false;
			...
			else if (item.catID == 19)// attachments
			{
				Marketplace.DescrBlock.WeaponStats.Stat1.visible = false;
				Marketplace.DescrBlock.Pic.y = 0.0;
					
				Marketplace.DescrBlock.WeaponStats.Stat2.Scale.scaleX = statsArr[0].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat2.Variable.text = statsArr[0].statName;
				Marketplace.DescrBlock.WeaponStats.Stat2.Value.text = String(statsArr[0].statValue)+"";

				Marketplace.DescrBlock.WeaponStats.Stat3.Scale.scaleX = statsArr[1].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat3.Variable.text = statsArr[1].statName;
				Marketplace.DescrBlock.WeaponStats.Stat3.Value.text = String(statsArr[1].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat4.Scale.scaleX = statsArr[2].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat4.Variable.text = statsArr[2].statName;
				Marketplace.DescrBlock.WeaponStats.Stat4.Value.text = String(statsArr[2].statValue)+"";
			}
			else if (item.catID == 12)// backpacks
			{
				Marketplace.DescrBlock.WeaponStats.Stat1.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat2.visible = false;
				Marketplace.DescrBlock.Pic.y = 10.0;

				Marketplace.DescrBlock.WeaponStats.Stat3.Scale.scaleX = statsArr[0].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat3.Variable.text = statsArr[0].statName;
				Marketplace.DescrBlock.WeaponStats.Stat3.Value.text = String(statsArr[0].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat4.Scale.scaleX = statsArr[1].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat4.Variable.text = statsArr[1].statName;
				Marketplace.DescrBlock.WeaponStats.Stat4.Value.text = String(statsArr[1].statValue)+"";
			}
			else if (item.catID == 30 || item.catID == 33)// food, water
			{				
				Marketplace.DescrBlock.WeaponStats.Stat5.visible = true;
				Marketplace.DescrBlock.Pic.y = -70.0;				
				
				Marketplace.DescrBlock.WeaponStats.Stat1.Scale.scaleX = statsArr[0].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat1.Variable.text = statsArr[0].statName;
				Marketplace.DescrBlock.WeaponStats.Stat1.Value.text = String(statsArr[0].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat2.Scale.scaleX = statsArr[1].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat2.Variable.text = statsArr[1].statName;
				Marketplace.DescrBlock.WeaponStats.Stat2.Value.text = String(statsArr[1].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat3.Scale.scaleX = statsArr[2].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat3.Variable.text = statsArr[2].statName;
				Marketplace.DescrBlock.WeaponStats.Stat3.Value.text = String(statsArr[2].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat4.Scale.scaleX = statsArr[3].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat4.Variable.text = statsArr[3].statName;
				Marketplace.DescrBlock.WeaponStats.Stat4.Value.text = String(statsArr[3].statValue)+"";
				
				Marketplace.DescrBlock.WeaponStats.Stat5.Scale.scaleX = statsArr[4].scaleX;
				Marketplace.DescrBlock.WeaponStats.Stat5.Variable.text = statsArr[4].statName;
				Marketplace.DescrBlock.WeaponStats.Stat5.Value.text = String(statsArr[4].statValue)+"";
			}
			else if(item.itemID == 101256 || item.itemID == 101261 || item.itemID == 101262 || 
					item.itemID == 101300 || item.itemID == 101302 || item.itemID == 101303 || item.itemID == 101304)// medic items
			{
				Marketplace.DescrBlock.WeaponStats.Stat1.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat2.visible = false;
				Marketplace.DescrBlock.WeaponStats.Stat3.visible = false;
			...
			{			
				while(iterator < statsArr.length)// weapons, ammo
				{
					Marketplace.DescrBlock.Pic.y = -36.0;
					var label = "Stat" + (iterator+1);
					Marketplace.DescrBlock.WeaponStats[label].Scale.scaleX = statsArr[iterator].scaleX;
					Marketplace.DescrBlock.WeaponStats[label].Variable.text = statsArr[iterator].statName;
					Marketplace.DescrBlock.WeaponStats[label].Value.text = String(statsArr[iterator].statValue)+"";
					iterator+=1;
				}
			}
		}
