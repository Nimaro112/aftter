package warz.vault {
	...
	public class Inventory extends MovieClip {
		...
		public function Inventory() {
			...
			this.Equiped.text = "$FR_EquipmentsSlots";
			this.QuickSlots.text = "$FR_quickslots";
...
// move item to this backpack slot					
		...
		public	function isItemAllowedInSlot (catID:int, slot:int):Boolean
		{
			...
			switch (slot)
			{
				...
				case	9:
					if (itemSlots[0] == 5)  // 3 = HATS idx of the item category
						isOK = true;
					break;

				case	10:
					if (itemSlots[0] == 5) // MaskGear
						isOK = true;
					break;

				case	11:
					if (itemSlots[0] == 5) // scarfgear
						isOK = true;
					break;
