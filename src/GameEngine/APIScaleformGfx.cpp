...
public:
	...
	// ui sounds IDs
	int			sndMenuBtnClick;
	int			sndMenuBtnClick2;
	int			sndMenuBtnClick3;
	int			sndMenuBtnClick4;
	int			sndMenuBtnClick5;
	int			sndMenuBtnClick6;
	int			sndMenuBtnHover;
	int			sndMenuBtnUse;
	int			sndMenuClose;
	int			sndMenuOpen;
...
// 	loader.GetFontCacheManager()->SetMaxRasterScale(1.2f);
	...
	*/
	...
	// load UI sounds
	sndMenuBtnClick = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Confirm_V2_01");
	sndMenuBtnClick2 = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Button_Click");
	sndMenuBtnClick3 = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Group_Message_Received_V2");
	sndMenuBtnClick4 = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Mystery_Box_Unlocking");
	sndMenuBtnClick5 = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/Loot_Item");
	sndMenuBtnClick6 = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Item_Purchase");
	sndMenuBtnHover = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Widget_Hover_B");
	sndMenuBtnUse = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Widget_Hover_B");

	sndMenuClose = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/UI_Widget_Hover_B");
	sndMenuOpen = SoundSys.GetEventIDByPath("Sounds/AM_Group/FrontEnd/UI_Mystery_Box_Unlocking");

	sndWeaponAttach = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/Weapon_Zoom_02");
	sndWeaponQuickChange = SoundSys.GetEventIDByPath("Sounds/AM_Group/MenuSnd/Weapon_Zoom_04");
...
void APIScaleformGfx::SetFontLib()
{
	...
	Scaleform::Ptr<Scaleform::GFx::MovieDef> fontMovie = *loader.CreateMovie("data/Interface/font_en.swf");
...
void r3dScaleformMovie::OnCommandCallback(const char* methodName, const Scaleform::GFx::Value* args, unsigned argCount)
{
	if(strstr(methodName, "eventSoundPlay"))
	{
		...
		else if(strcmp(soundName, "menu_click2")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnClick2, r3dPoint3D(0,0,0));
		else if(strcmp(soundName, "menu_click3")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnClick3, r3dPoint3D(0,0,0));
		else if(strcmp(soundName, "menu_click4")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnClick4, r3dPoint3D(0,0,0));
		else if(strcmp(soundName, "menu_click5")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnClick5, r3dPoint3D(0,0,0));
		else if(strcmp(soundName, "menu_click6")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnClick6, r3dPoint3D(0,0,0));
		else if(strcmp(soundName, "menu_hover")==0)
			SoundSys.PlayAndForget(gAPIScaleformGfx->sndMenuBtnHover, r3dPoint3D(0,0,0));
