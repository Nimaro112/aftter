...
// 	loader.GetFontCacheManager()->SetMaxRasterScale(1.2f);
	...
	*/
	...
	sndMenuBtnUse = SoundSys.GetEventIDByPath("Sounds/WarZ/MainMenu GUI/UI_Item_Move_Equip");
	sndMenuClose = SoundSys.GetEventIDByPath("Sounds/MainMenu GUI/UI_Menu_Open_v2");
	sndMenuOpen = SoundSys.GetEventIDByPath("Sounds/WarZ/MainMenu GUI/UI_Menu_Open_v2");
	sndWeaponAttach = SoundSys.GetEventIDByPath("Sounds/MainMenu GUI/UI_weapon_attach");
	sndWeaponQuickChange = SoundSys.GetEventIDByPath("Sounds/MainMenu GUI/Mine_Place");
