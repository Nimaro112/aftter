...
struct GBGameInfo
{
	enum EMapId
	{
	  ...
	  MAPID_AM_Island,
	  MAPID_AM_Battleroyale,
	  MAPID_AM_Compound,
	  MAPID_AM_ConventionC,
	  MAPID_AM_Devmap,
	  MAPID_AM_PineTop,
	  MAPID_AM_RoTB,
	  MAPID_AM_Nevada,
	  MAPID_AM_SouthWest,
	  MAPID_AM_RentServer01,
	  MAPID_AM_RentServer02,
	  MAPID_MAX_ID,
	};
	...
	GBGameInfo()
	{
	  ...
	  gameServerId = 0;
	  gameTimeLimit = 0;
	  isBattleRoyaleMode = 0;//battleroyale
	  channel = 0;
	...
	{
	  return mapId == MAPID_AM_Island ||
			 mapId == MAPID_AM_PineTop ||
			 mapId == MAPID_AM_RoTB ||
			 mapId == MAPID_AM_Nevada ||
			 mapId == MAPID_AM_SouthWest ||
			 mapId == MAPID_AM_RentServer01 ||
			 mapId == MAPID_AM_RentServer02;
	}

	bool isBattleRoyaleMap() const
	{
	  return mapId == MAPID_AM_Battleroyale;
	}

	bool IsDeathMatch() const
	{
	  return mapId == MAPID_AM_Compound ||
			 mapId == MAPID_AM_ConventionC;
	}
